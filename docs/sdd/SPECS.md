...
- [ ] **SPEC-002** | Brand Entity | Entity | Organization | Fase 1 (Plataforma Fundacional) | P0 | DRAFT | NOT_ASSESSED
- [ ] **SPEC-003** | FiscalEntity Entity | Entity | Organization | Fase 1 | P0 | PLANNED | NOT_ASSESSED
...
- [ ] **SPEC-010** | Branches API | API | Organization | Fase 1 | P0 | PLANNED | NOT_ASSESSED
- [ ] **SPEC-011** | Salons API | API | Organization | Fase 1 | P1 | PLANNED | NOT_ASSESSED
- [ ] **SPEC-012** | Tables API | API | Organization | Fase 1 | P1 | PLANNED | NOT_ASSESSED
