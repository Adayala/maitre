...
// Dual-mode auth, copied from apps/web / apps/kitchen (SPEC-023): a real
// Supabase session when configured, or a fixture bearer token pasted on the
// login screen. A waiter signs in on their personal phone at the start of a
// shift, so the fixture token is persisted in sessionStorage under a
// cashier-scoped key.
interface AuthState {
...
const FIXTURE_TOKEN_KEY = "maitre.cashier.fixtureAccessToken";
