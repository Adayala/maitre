...
// Resolves the acting context for the waiter: which tenant + branch they are
// working in this shift. Mirrors apps/kitchen's session-context. Both
// selections are sticky in localStorage and auto-resolve when there is only
// one option — a waiter usually taps nothing and lands straight on the floor.
...
const TENANT_KEY = "maitre.waiter.selectedTenantId";
const BRANCH_KEY = "maitre.waiter.selectedBranchId";
