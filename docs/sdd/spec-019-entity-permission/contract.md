...
evalúa tenant, branch scope, estado de membership y reglas de dominio.
...
3. Deny/ausencia gana ante permiso desconocido o scope insuficiente.
...
- Tests cubren permiso ausente, deprecated, scope incorrecto y confused deputy.
