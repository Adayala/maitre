...
export interface OccupancyRepositoryPort {
  ...
  findActiveByTable(tenantId: string, tableId: string): Promise<Occupancy | null>;
...
export interface PaymentRepositoryPort {
  ...
  findByIdempotencyKey(tenantId: string, idempotencyKey: string): Promise<Payment | null>;
...
export interface ServicePeriodRepositoryPort {
  ...
  findActiveByBranch(tenantId: string, branchId: string): Promise<ServicePeriod | null>;
