...
A central mapper converts known domain, authorization, validation and dependency errors to RFC
9457. The response always sets `application/problem+json` and includes an absolute stable `type`,
