...
- **AUTH-002:** un access token sólo prueba identidad; roles, tenants, sucursales y entitlements se resuelven server-side.
...
- **AUTH-009:** tokens, passwords, códigos, cookies y secretos nunca aparecen completos en logs, métricas, traces o errores.
