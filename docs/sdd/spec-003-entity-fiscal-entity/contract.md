...
FiscalEntity representa al sujeto fiscal que emite comprobantes para una o más sucursales.
...
regla legal. Tests cubren CUIT, vigencias, redacción, relación con sucursales y aislamiento cross-tenant.
