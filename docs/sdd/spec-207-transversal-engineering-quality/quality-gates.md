...
| coverage con baseline versionado | `npm run test:coverage`    |                       sí |         sí |      sí |
...
- Coverage falla si líneas bajan de 78 %, branches de 82 % o funciones de 81 %; los umbrales viven en `tooling/quality/coverage-thresholds.json`.
