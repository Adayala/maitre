...
- [ ] Configurar ESLint flat, React Hooks y reglas type-aware.
- [ ] Configurar Prettier sin conflicto con ESLint.
- [ ] Configurar dependency-cruiser y probar una violación.
- [ ] Configurar Vitest, cobertura V8 y reportes Sonar.
- [ ] Crear app React.js con Vite.
- [ ] Configurar React Router y TanStack Query.
- [ ] Crear API Fastify con entradas Node/Vercel.
