# Contrato de entidad — SPEC-111 Shift

Shift representa una ventana laboral planificada de una sucursal con inicio, fin, timezone,
...
solapamientos permitidos por política, concurrencia y aislamiento tenant/branch.
