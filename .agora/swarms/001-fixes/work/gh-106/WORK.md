...
satisfied-criteria: []
criterion-statuses: {"availability":[],"confirmation":[],"seating":[],"tenant-config":[],"tests":[]}
required-artifacts: []
child-work-refs: []
budget-limits: null
---
...
- [ ] **availability:** Queda probado y documentado si la disponibilidad usa capacidad declarada, capacidad de mesas o una regla configurable.; stages: none
- [ ] **confirmation:** Queda probado y documentado si puede confirmarse una reserva en un salón sin mesas.; stages: none
- [ ] **seating:** El resultado de seat para una reserva sin mesas es determinista, seguro y documentado.; stages: none
- [ ] **tenant-config:** La decisión considera configuración por tenant y no introduce defaults globales rígidos.; stages: none
- [ ] **tests:** Cualquier código modificado alcanza 100% de statements, branches, functions y lines y se cubre el recorrido E2E afectado.; stages: none
