...
2. Nadie se otorga a sí mismo roles/scopes.
...
6. Scope de branch sólo puede ser subconjunto del scope del actor.
...
cross-tenant, membership inactiva y branch fuera de scope. Respuestas evitan enumeración y
