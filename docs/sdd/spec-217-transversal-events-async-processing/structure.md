...
Este documento define la descomposición documental y los límites de responsabilidad de **Eventos y procesamiento asíncrono**. No prescribe una implementación adicional a la aprobada en `specification.md`.
...
- Los nueve artefactos base (`README`, specification, contract, objective, rules, structure, plan, tasks y verification) existen y comparten el identificador SPEC-217.
