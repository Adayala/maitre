...
Este documento define la descomposición documental y los límites de responsabilidad de **Sistema de diseño y accesibilidad**. No prescribe una implementación adicional a la aprobada en `specification.md`.
...
- Los nueve artefactos base (`README`, specification, contract, objective, rules, structure, plan, tasks y verification) existen y comparten el identificador SPEC-212.
