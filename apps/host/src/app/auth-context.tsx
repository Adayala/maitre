...
// token pasted on the login screen. The host/maître app stays isolated from
// the other role apps with its own storage key.
interface AuthState {
...
const FIXTURE_TOKEN_KEY = "maitre.host.fixtureAccessToken";
