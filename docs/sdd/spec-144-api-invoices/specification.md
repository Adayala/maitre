...
`GET /invoices/{invoiceId}/document` entrega un fallback HTML descargable únicamente para
comprobantes `AUTHORIZED`. El contenido se deriva del snapshot fiscal, titular y punto de venta
