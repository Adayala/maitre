...
// Adapted from apps/web's SPEC-048 StateView / apps/kitchen: a stable loading
// layout, an actionable/recoverable error, and a calm, positive empty state
// rather than a scary blank panel.
